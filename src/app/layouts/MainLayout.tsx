...
import { PanelLeftOpen, PanelLeftClose, LayoutDashboard, LogOut, Settings, CircleUser } from "lucide-react";
...
const PDFDrawer = dynamic(() => import('@/features/chat/components/PdfDrawer'), { ssr: false });
                    ...
                    <div className="pointer-events-auto mr-2">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="bg-[#2a2a2d] text-white border-none">
                                <DropdownMenuItem className="flex items-center gap-2 text-gray-400 pointer-events-none cursor-default hover:bg-transparent">
